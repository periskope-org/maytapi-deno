...
export class SessionInformationGettersApiRequestFactory extends BaseAPIRequestFactory {
   ...
   */
  public async phoneIdContactCidGet(
    phoneId: string,
   ...
   * @param phoneId ID of the phone registered to the product, assigned by the database automatically. Can be obtained by calling ***GET listPhones***.
   */
  public async phoneIdContactsGet(
    phoneId: string,
    _options?: Configuration
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = "/{phone_id}/contacts".replace(
      "{" + "phone_id" + "}",
      encodeURIComponent(String(phoneId))
    );
  ...
  public async phoneIdQrCodeGet(
    ...
    // Path Params
    const localVarPath = "/{phone_id}/qrCode".replace(
      "{" + "phone_id" + "}",
      encodeURIComponent(String(phoneId))
    );
  ...
  public async phoneIdScreenGet(
    ...
    // Path Params
    const localVarPath = "/{phone_id}/screen".replace(
      "{" + "phone_id" + "}",
      encodeURIComponent(String(phoneId))
    );
  ...
  public async phoneIdStatusGet(
    ...
    // Path Params
    const localVarPath = "/{phone_id}/status".replace(
      "{" + "phone_id" + "}",
      encodeURIComponent(String(phoneId))
    );
...
export class SessionInformationGettersApiResponseProcessor {
  ...
  ): Promise<PhoneIdContactCidGet200Response> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"]
    );
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: PhoneIdContactCidGet200Response =
  ...
  public async phoneIdContactsGet(
    response: ResponseContext
  ): Promise<PhoneIdContactsGet200Response> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"]
    );
    if (isCodeInRange("200", response.httpStatusCode)) {
