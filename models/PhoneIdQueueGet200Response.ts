...
export class PhoneIdQueueGet200Response {
    'success'?: boolean;
    'stats'?: PhoneIdQueueGet200ResponseStats;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "stats",
            "baseName": "stats",
            "type": "PhoneIdQueueGet200ResponseStats",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return PhoneIdQueueGet200Response.attributeTypeMap;
    }
