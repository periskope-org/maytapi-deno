...
export class WebhookLiveBodyData {
    'event'?: WebhookLiveBodyDataEventEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "event",
            "baseName": "event",
            "type": "WebhookLiveBodyDataEventEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return WebhookLiveBodyData.attributeTypeMap;
    }
...
export type WebhookLiveBodyDataEventEnum = "taken_by_agent" | "closed" | "released_by_agent" ;
