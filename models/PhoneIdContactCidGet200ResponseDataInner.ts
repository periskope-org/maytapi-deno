...
export class PhoneIdContactCidGet200ResponseDataInner {
    'id'?: string;
    'name'?: string;
    'type'?: PhoneIdContactCidGet200ResponseDataInnerTypeEnum;
    'image'?: string;
    ...
    static getAttributeTypeMap() {
        return PhoneIdContactCidGet200ResponseDataInner.attributeTypeMap;
    }
...
export type PhoneIdContactCidGet200ResponseDataInnerTypeEnum = "chat" | "group" | "broadcast" ;
