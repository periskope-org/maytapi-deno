...
export class WebhookAckData {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "ackType",
            "baseName": "ackType",
            "type": "WebhookAckDataAckTypeEnum",
            "format": ""
        },
        {
            "name": "ackCode",
            "baseName": "ackCode",
            "type": "WebhookAckDataAckCodeEnum",
            "format": ""
        },
        {
            "name": "chatId",
    ...
    static getAttributeTypeMap() {
        return WebhookAckData.attributeTypeMap;
    }
...
export type WebhookAckDataAckTypeEnum = "delivered" | "reached" | "seen" | "played" | "deleted" ;
export type WebhookAckDataAckCodeEnum = "1" | "2" | "3" | "4" | "5" ;
