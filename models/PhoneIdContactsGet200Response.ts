...
export class PhoneIdContactsGet200Response {
    'success'?: boolean;
    'data'?: Array<PhoneIdContactsGet200ResponseDataInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<PhoneIdContactsGet200ResponseDataInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return PhoneIdContactsGet200Response.attributeTypeMap;
    }
