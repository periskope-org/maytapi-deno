...
export class PhoneIdContactCidGet200Response {
    'success'?: boolean;
    'data'?: Array<PhoneIdContactCidGet200ResponseDataInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<PhoneIdContactCidGet200ResponseDataInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return PhoneIdContactCidGet200Response.attributeTypeMap;
    }
