...
export class PhoneIdGroupConfigPost200Response {
    'success'?: boolean;
    'data'?: PhoneIdGroupConfigPostRequestConfig;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "PhoneIdGroupConfigPostRequestConfig",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return PhoneIdGroupConfigPost200Response.attributeTypeMap;
    }
