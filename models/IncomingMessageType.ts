...
export class IncomingMessageType {
    'productId'?: string;
    'phoneId'?: string;
    'message'?: MessageData;
    ...
    'type'?: string;
    /**
    * Reply url for ease of use.
    */
    'reply'?: string;
    'quoted'?: MessageQuotedData | null;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "quoted",
            "baseName": "quoted",
            "type": "MessageQuotedData",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return IncomingMessageType.attributeTypeMap;
    }
