...
export class PhoneIdContactsGet200ResponseDataInner {
    'id'?: string;
    'name'?: string;
    'type'?: PhoneIdContactsGet200ResponseDataInnerTypeEnum;
    ...
    static getAttributeTypeMap() {
        return PhoneIdContactsGet200ResponseDataInner.attributeTypeMap;
    }
...
export type PhoneIdContactsGet200ResponseDataInnerTypeEnum = "chat" | "group" | "broadcast" ;
