...
export class PromiseGroupChatOperationsApi {
     ...
     */
    public phoneIdSetProfileImagePost(phoneId: string, phoneIdSetProfileImagePostRequest: PhoneIdSetProfileImagePostRequest, _options?: Configuration): Promise<PhoneIdSetProfileImagePost200Response> {
...
export class PromiseMessageSendingOperationsApi {
     ...
     */
    public phoneIdSendMessagePost(phoneId: string, sendMessageBody: SendMessageBody, _options?: Configuration): Promise<SendMessageResponse> {
        const result = this.api.phoneIdSendMessagePost(phoneId, sendMessageBody, _options);
        return result.toPromise();
    }
